        ...
        <div id="feature-1">
            <div id="feature-1-header" class="flex items-center space-x-2 mb-1">
               ...
               <div class="flex" id="feature-1-title-container">
                    <h4 id="feature-1-title" class="flex-1 text-slate-50 font-medium">Immersive Gameplay</h4>
                </div>
            </div>
            <div class="flex" id="feature-1-description-container">
                <p id="feature-1-description" class="flex-1 text-sm">Dive into a captivating world with stunning graphics and engaging storylines that will keep you hooked for hours.</p>
            </div>
        </div>
        ...
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container">
                    <h4 id="feature-2-title" class="flex-1 text-slate-50 font-medium">Multiplayer Fun</h4>
                </div>
            </div>
            <div class="flex" id="feature-2-description-container">
                <p id="feature-2-description" class="flex-1 text-sm">Connect with friends and players worldwide for exciting competitive or cooperative gameplay experiences.</p>
            </div>
        </div>
        ...
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container">
                    <h4 id="feature-3-title" class="flex-1 text-slate-50 font-medium">Customization Options</h4>
                </div>
            </div>
            <div class="flex" id="feature-3-description-container">
                <p id="feature-3-description" class="flex-1 text-sm">Personalize your character, gear, and playstyle with a wide array of customization choices to suit your preferences.</p>
            </div>
        </div>
        ...
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container">
                    <h4 id="feature-4-title" class="flex-1 text-slate-50 font-medium">Regular Updates</h4>
                </div>
            </div>
            <div class="flex" id="feature-4-description-container">
                <p id="feature-4-description" class="flex-1 text-sm">Enjoy fresh content, new challenges, and exciting events with our frequent game updates and expansions.</p>
            </div>
        </div>
        ...
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container">
                    <h4 id="feature-5-title" class="flex-1 text-slate-50 font-medium">Accessible Controls</h4>
                </div>
            </div>
            <div class="flex" id="feature-5-description-container">
                <p id="feature-5-description" class="flex-1 text-sm">Experience smooth and intuitive gameplay with our user-friendly controls, suitable for both beginners and experienced players.</p>
            </div>
        </div>
        ...
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container">
                    <h4 id="feature-6-title" class="flex-1 text-slate-50 font-medium">Cross-Platform Play</h4>
                </div>
            </div>
            <div class="flex" id="feature-6-description-container">
                <p id="feature-6-description" class="flex-1 text-sm">Play seamlessly across multiple devices and platforms, allowing you to enjoy the game wherever you go.</p>
            </div>
        </div>
    </div>
</template>
